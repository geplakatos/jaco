...
public class RecordAndEncodeVideo {
  ...
  private static void recordScreen(String filename, String formatname,
    ...
    final Rectangle screenbounds = new Rectangle(0,0,200,200);//toolkit.getScreenSize());
    ...
    //System.out.println(codec);System.exit(8);
    ...
    final PixelFormat.Type pixelformat = PixelFormat.Type.PIX_FMT_YUVJ420P;//.PIX_FMT_ABGR;//.PIX_FMT_YUV420P;
